...
export default function Product(){
 ...
 return <><Seo title={product.seo_title||product.title} description={product.seo_description||product.short_description||`Discover ${product.title} from Ivy & Pearls.`} path={`/product/${product.slug}/`} image={image?.url} jsonLd={[schema,breadcrumb]}/>
