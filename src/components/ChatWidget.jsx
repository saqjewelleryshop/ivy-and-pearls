...
export default function ChatWidget(){useEffect(()=>{
 const bot=import.meta.env.VITE_ZOCHAT_BOT_ID;if(!bot)return;
 let timer,observer;
 const load=()=>{if(document.querySelector('script[data-chatbot]'))return;const s=document.createElement('script');s.async=true;s.src='https://woo-chat-bot-widget.netlify.app/widget.js';s.dataset.chatbot=bot;document.body.appendChild(s);
