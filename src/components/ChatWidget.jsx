...
export default function ChatWidget(){useEffect(()=>{
 ...
 let timer,observer;
 const load=()=>{if(document.querySelector('script[data-chatbot]'))return;const s=document.createElement('script');s.async=true;s.src='https://woo-chat-bot-widget.netlify.app/widget.js';s.dataset.chatbot=bot;s.onerror=()=>console.warn('Client-care chat is temporarily unavailable.');document.body.appendChild(s);
